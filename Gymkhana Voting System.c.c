...
int *z;
 z = &UNIVERSAL;
     ...
     while(temp!=NULL)
     {
         if((strcmp(temp->aadhar,"10001")==0&& strcmp(temp->name,"Aman Kujur")==0 &&strcmp(temp->birth_date,"23-09-2004")==0) ||
         (strcmp(temp->aadhar,"10002")==0&& strcmp(temp->name,"Divyansh Kumar")==0 &&strcmp(temp->birth_date,"01-01-1999")==0)||
         ...
         (strcmp(temp->aadhar,"10010")==0&& strcmp(temp->name,"Rahul Raj")==0 &&strcmp(temp->birth_date,"20-09-2003")==0))
